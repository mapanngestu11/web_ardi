      ...
      <?php foreach ($pegawai->result_array() as $row) :
        ...
        <div class="modal fade " id="ModalEdit<?php echo $id_pegawai; ?>" role="dialog" aria-hidden="true" data-backdrop="static">
          <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="myModalLabel1">Update Data Pegawai</h5>
                <button type="button" class="close rounded-pill" data-bs-dismiss="modal" aria-label="Close">
                  <i data-feather="x"></i>
                </button>
              </div>
                  ...
                  <form action="<?php echo base_url() . 'Admin/Pegawai/update'; ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <label>Nip</label>
                        <div class="form-group form-input">
                          <input type="text" name="nip" placeholder="Nip" class="form-control" required value="<?php echo $nip;?>" >
                      ...
                      <div class="col-md-6">
                        <label>Nama Pegawai</label>
                        <div class="form-group form-input">
                          <input type="text" name="nama" placeholder="Nama " class="form-control" required  value="<?php echo $nama;?>">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <label>Jabatan</label>
                        <div class="form-group form-input">
                          <input type="text" name="jabatan" placeholder="Jabatan" class="form-control" required value="<?php echo $jabatan;?>" >
                        </div>
                      </div>
                      <div class="col-md-6">
                        <label>Foto</label>
                        <div class="form-group form-input">
                          <input type="file" name="foto" placeholder="Jabatan" class="form-control" >
                        </div>
                      </div>
                    </div>
